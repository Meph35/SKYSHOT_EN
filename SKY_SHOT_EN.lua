...
function FunMods()
	 -- Mover la inicialización de sys fuera de todas las funciones
	...
	while true do
		...
		if sys == 1 then
			...
			elseif suitf == 9 then
				SIUfire()
			elseif suitf == 10 then
				suikrills()
			elseif suitf == 11 then
				iosphone()
			elseif suitf == 12 then
				SuiOxygen()
			elseif suitf == 13 then
				Suihearts()
			elseif suitf == 14 then
				wing_charge()
			elseif suitf == 15 then
				suimenuem()
			elseif suitf == 16 then
				wingpowers()
			elseif suitf == 17 then
				clothes()
			elseif suitf == 18 then
				UnlockSeason()
			elseif suitf == 19 then
				quick()
			elseif suitf == 20 then
				invisiblecape()
			elseif suitf == 21 then
				lightplayers()
			elseif suitf == 22 then
				quickhome()
			elseif suitf == 23 then
			     iap() 
			elseif suitf == 24 then
			    start()
			end
		end
